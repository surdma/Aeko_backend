...
const authRepository: AuthRepository = {
  findIdentityById: vi.fn(async (userId) => identities[userId as keyof typeof identities] ?? null),
...
describe('interests domain', () => {
  ...
  beforeEach(async () => {
    for (const value of Object.values(interestsRepository)) {
  ...
  it('loads and updates user interests with the legacy envelopes', async () => {
